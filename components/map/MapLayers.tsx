...
import { ArrowUpRight, Check, ChevronDown, Gem, Swords, X } from 'lucide-react';
...
export default function MapLayers() {
  ...
  const detailsOpen = resourcesVisible && (legendOpen || selected !== null);
  ...
  return (
    <div className="map-layers" data-testid="map-layers">
